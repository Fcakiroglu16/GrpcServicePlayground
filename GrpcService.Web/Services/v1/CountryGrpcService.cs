...
using Grpc.Core;
using GrpcService.Web.ManagmentService.v1;
using Samples.gRPC.v1;

namespace GrpcService.Web.Services.v1;
public class CountryGrpcService : Samples.gRPC.v1.CountryService.CountryServiceBase
{
